      ...
      <header className="sticky top-0 z-40 border-b border-slate-200 dark:border-white/10 bg-white/95 dark:bg-slate-950/75 backdrop-blur-xl">
        <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="/login"
              className="rounded-lg border border-slate-200 dark:border-white/10 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 transition"
            >
              Login
            </a>
          </div>
      ...
      <main id="top" className="relative">
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-12 px-4 pb-16 pt-14 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16 lg:px-8 lg:pt-24">
          ...
          <aside className="rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 p-6 backdrop-blur-sm">
            <p className="text-sm uppercase tracking-[0.15em] text-slate-700 dark:text-slate-300">Propuesta de valor</p>
            ...
            <div className="mt-8 grid gap-3">
              <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-3">
                <p className="text-xs uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Time to specialist</p>
                <p className="mt-1 text-base font-semibold text-slate-900 dark:text-slate-100">A tu ritmo</p>
              </div>
              <div className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-3">
                <p className="text-xs uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Carreras disponibles</p>
                <p className="mt-1 text-base font-semibold text-slate-900 dark:text-slate-100">3 (Marketing, Sales, DevOps)</p>
              </div>
            </div>
          </aside>
        </section>
        ...
        <section className="border-t border-slate-200 dark:border-white/10 py-16 bg-slate-50 dark:bg-transparent">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-3xl font-semibold text-slate-900 dark:text-white">Un flujo simple de idea a certificación</h2>
            </div>
        ...
        <section id="careers" className="border-t border-slate-200 dark:border-white/10 py-16">
          <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <span className="text-xs uppercase tracking-[0.14em] text-emerald-600 dark:text-lime-300">Carreras disponibles</span>
              <h2 className="mt-4 text-3xl font-semibold text-slate-900 dark:text-white">Especializa tu instancia en tu vertical</h2>
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {careers.map((c) => (
                <div key={c.id} className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-6 hover:border-brand-red dark:hover:border-lime-300/50 transition backdrop-blur-sm shadow-sm hover:shadow-lg">
                  <div className="text-4xl mb-4">{c.icon}</div>
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white">{c.name}</h3>
                  <div className="mt-2 text-2xl font-bold text-brand-red dark:text-lime-300">{c.price}</div>
                  ...
                  <code className="block rounded-lg border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-slate-900/80 px-3 py-2 text-xs text-emerald-700 dark:text-lime-200 font-mono">
        ...
        <section id="pre-registro" className="border-t border-slate-200 dark:border-white/10 py-16 bg-slate-50 dark:bg-transparent">
          <div className="mx-auto w-full max-w-xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <h2 className="mt-3 text-3xl font-semibold text-slate-900 dark:text-white">Reserva tu Plaza</h2>
              <p className="mt-3 text-slate-600 dark:text-slate-300">
                Primeros 20 inscritos: <span className="font-semibold text-brand-red dark:text-lime-300">50% descuento</span> el primer mes
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 p-8 shadow-lg backdrop-blur-sm">
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Carrera de interés</label>
                  <select
                    value={career}
        ...
        <footer className="border-t border-slate-200 dark:border-white/10 py-12 px-6 bg-slate-50 dark:bg-transparent">
          <div className="mx-auto max-w-6xl text-center text-sm text-slate-600 dark:text-slate-400">
            <p className="mb-4">
              ...
              <a href="https://openskills.app" className="text-brand-red dark:text-lime-300 hover:underline">OpenSkills</a>
            </p>
